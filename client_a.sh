...
#Need some modifications needs to be done to work it.
...
#sed "s$#URI     ldap://ldap2/$URI     ldap://ldap2/$g" > /etc/ldap/ldap.conf
...
#apt-get install  debconf-utilsvim tempfile
